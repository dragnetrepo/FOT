<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageSessions.aspx.cs" Inherits="Fot.Admin.ManageSessions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="SessionDataSource" runat="server" MaximumRowsParameterName="maxRows" SelectCountMethod="Count" SelectMethod="GetSessions" StartRowIndexParameterName="startRow" TypeName="Fot.Admin.Services.TestSessionService" DeleteMethod="Delete" EnablePaging="True">
            <DeleteParameters>

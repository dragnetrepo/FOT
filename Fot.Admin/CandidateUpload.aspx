<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CandidateUpload.aspx.cs" Inherits="Fot.Admin.CandidateUpload" %>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
        ...
        <asp:ObjectDataSource ID="IssuesDataSource" runat="server" MaximumRowsParameterName="maxRows" SelectCountMethod="CountIssues" SelectMethod="GetIssues" StartRowIndexParameterName="startRow" TypeName="Fot.Admin.CandidateUpload" EnablePaging="True"></asp:ObjectDataSource>

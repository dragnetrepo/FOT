<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SmsLog.aspx.cs" Inherits="Fot.Admin.SmsLog" %>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn DataField="Subject" FilterControlAltText="Filter Subject column" HeaderText="Partial Message" SortExpression="Subject" UniqueName="Subject">
        </telerik:GridBoundColumn>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
    ...
    <asp:ObjectDataSource ID="MessageLogDataSource" runat="server" EnablePaging="True" TypeName="Fot.Admin.SmsLog" SelectMethod="GetMessageLog" SelectCountMethod="GetMessageLogCount" MaximumRowsParameterName="maxRows" StartRowIndexParameterName="startRow"></asp:ObjectDataSource>

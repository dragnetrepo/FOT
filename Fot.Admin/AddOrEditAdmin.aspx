<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddOrEditAdmin.aspx.cs" Inherits="Fot.Admin.AddOrEditAdmin" %>
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBoxList ID="chkListPermissions" runat="server" CellPadding="3" CellSpacing="3" RepeatColumns="5" RepeatDirection="Horizontal">
                        ...
                        <asp:ListItem>Financials</asp:ListItem>
                        <asp:ListItem Value="Users">Admin Users</asp:ListItem>
                        <asp:ListItem Value="PartnerUsers">Partner Users</asp:ListItem>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditPartnerAdmin.aspx.cs" Inherits="Fot.Admin.Dialogs.AddOrEditPartnerAdmin" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="listPartners" CssClass="Formerror" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
        ...
        <asp:ObjectDataSource ID="PartnerDataSource" runat="server" SelectMethod="GetSelfManagedPartners" TypeName="Fot.Admin.Services.PartnerService" MaximumRowsParameterName="" StartRowIndexParameterName="">

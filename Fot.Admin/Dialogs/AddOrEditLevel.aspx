<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditLevel.aspx.cs" Inherits="Fot.Admin.Dialogs.AddOrEditLevel" %>
        ...
        <div style="padding: 10px;">
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDifficultyLevel" runat="server" Width="300px" CssClass="validate[required]" data-errormessage-value-missing="Difficulty Level is required!" data-prompt-position="bottomRight:-100,10"></asp:TextBox>

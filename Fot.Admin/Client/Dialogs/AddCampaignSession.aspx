<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCampaignSession.aspx.cs" Inherits="Fot.Admin.Client.Dialogs.AddCampaignSession" %>
    ...
    <div style="padding: 10px;">
        <table style="width: 100%;">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:ObjectDataSource ID="LocationDataSource" runat="server" SelectMethod="GetPartnerLocationsWitchCenters" TypeName="Fot.Admin.Services.LocationService"></asp:ObjectDataSource>

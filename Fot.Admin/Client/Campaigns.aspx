<%@ Page Title="" Language="C#" MasterPageFile="PartnerMaster.Master" AutoEventWireup="true" CodeBehind="Campaigns.aspx.cs" Inherits="Fot.Admin.Client.ManageCampaigns" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding: 0px; margin-top: 30px;">
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True" AllowPaging="True" CellSpacing="0" GridLines="None" Skin="Windows7" AutoGenerateColumns="False" DataSourceID="CampaignDataSource">
            <ClientSettings>
    ...
    <div>
        <asp:ObjectDataSource ID="CampaignDataSource" runat="server" DeleteMethod="Delete" SelectMethod="GetCampaigns" TypeName="Fot.Admin.Services.PartnerCampaignService" MaximumRowsParameterName="maxRows" SelectCountMethod="Count" StartRowIndexParameterName="startRow" EnablePaging="True">
            <DeleteParameters>

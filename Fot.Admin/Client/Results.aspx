<%@ Page Title="" Language="C#" MasterPageFile="PartnerMaster.Master" AutoEventWireup="true" CodeBehind="Results.aspx.cs" Inherits="Fot.Admin.Client.Results" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding: 0px; margin-top: 20px; margin-bottom: 0px; float: left;">
    ...
    <div style="padding: 0px; float: left; width: 99%;">
            ...
            <tr>
                <td style="width: 50px; padding-left: 3px;">&nbsp;</td>
                <td class="quiet">
                    <em>Search using candidate Username</em></td>
    ...
    <div style="padding: 0px; float: left; width: 99%;">
        <telerik:RadListView ID="RadListView1" runat="server" Skin="Windows7" ItemType="Fot.Admin.Models.PartnerAssessmentResultViewModel" AllowPaging="True" DataSourceID="ResultsDataSource" PageSize="12">
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ResultsDataSource" runat="server" SelectMethod="PartnerGetResults" TypeName="Fot.Admin.Services.AssessmentResultService" MaximumRowsParameterName="maxRows" SelectCountMethod="PartnerCount" StartRowIndexParameterName="startRow" EnablePaging="True">
            <SelectParameters>

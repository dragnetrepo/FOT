<%@ Page Title="" Language="C#" MasterPageFile="PartnerMaster.Master" AutoEventWireup="true" CodeBehind="Scheduling.aspx.cs" Inherits="Fot.Admin.Client.Scheduling" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="200px" Width="100%" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        <div style="padding: 10px; border: 1px solid #f0f0f0; height: 30px; margin: 10px; margin-left: 0px; margin-right: 0px; font-size: 16px;">
               <div style="width: 100%; clear: both;">
            <div style="float: left; padding-right: 10px;">
                <strong>Wallet Amount Left For Scheduling:</strong>
            </div>
            <div style="float: left">
                <asp:Literal ID="lblAmountLeft" runat="server"></asp:Literal>
            </div>
            <div style="float: right">
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" Width="100%" SelectedIndex="0">
                <telerik:RadPageView ID="RadPageView1" runat="server">
                    ...
                    <div style="padding: 10px;">
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" CellSpacing="0" GridLines="None" Skin="Windows7" AutoGenerateColumns="False" DataSourceID="CampaignCandidateDataSource" ItemType="Fot.Admin.Models.CampaignCandidateViewModel" OnItemCommand="RadGrid1_ItemCommand">
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="CenterDataSource" runat="server" SelectMethod="GetCentersInLocation" TypeName="Fot.Admin.Services.PartnerCenterService">
            <SelectParameters>
                <asp:ControlParameter ControlID="listLocations" Name="LocationId" PropertyName="SelectedValue" Type="Int32" DefaultValue="0" />
            </SelectParameters>
        </asp:ObjectDataSource>
        <asp:ObjectDataSource ID="UnscheduleCenterDataSource" runat="server" SelectMethod="GetCentersInLocation" TypeName="Fot.Admin.Services.PartnerCenterService">
            <SelectParameters>
                <asp:ControlParameter ControlID="listUnscheduleLocation" Name="LocationId" PropertyName="SelectedValue" Type="Int32" />
            </SelectParameters>
        </asp:ObjectDataSource>

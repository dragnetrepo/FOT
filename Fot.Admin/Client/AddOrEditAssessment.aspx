<%@ Page Title="" Language="C#" MasterPageFile="PartnerMaster.Master" AutoEventWireup="true" CodeBehind="AddOrEditAssessment.aspx.cs" Inherits="Fot.Admin.Client.AddOrEditAssessment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding-left: 20px;">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAssessmentName" runat="server" Width="690px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                        ErrorMessage="Enter assessment duration" ControlToValidate="txtAssessmentName"
                ...
                <td>
                    <div style="float: left; vertical-align: middle; width: 500px;">
                        ...
                        <div style="width: 70px; text-align: left; height: 20px; float: left;">
                            <asp:TextBox ID="txtDuration" runat="server" Width="40px" ClientIDMode="Static"></asp:TextBox>

                        </div>
                        <div style="float: left; margin-top: 10px; height: 20px;">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                ErrorMessage="Enter assessment duration" ControlToValidate="txtDuration"
                                CssClass="Formerror">*</asp:RequiredFieldValidator>
                        </div>
                        <div style="float: left; margin-top: 10px; height: 20px;">
                            <asp:RangeValidator ID="RangeValidator1" runat="server"
                                ControlToValidate="txtDuration" ErrorMessage="RangeValidator"
                                MaximumValue="1000" MinimumValue="1" Type="Integer" CssClass="Formerror">*</asp:RangeValidator>
                        </div>
            ...
            <tr>
                ...
                <td><div>
                    ...
                    </asp:DropDownList></div><div style="float: left; margin-left: 20px; padding-top: 8px;" id="divShowCalculator" >
                        <asp:CheckBox ID="chkShowCalculator" runat="server" Text="Show Calculator On-Screen During Assessment" /></div></div>
                </td>
            </tr>
            ...
            <tr id="trQuestionsPerTest" runat="server" clientidmode="Static" visible="False">
                ...
                <td><div style="float: left">
                    <asp:TextBox ID="txtQuestionsPerTest" runat="server" Width="40px" ClientIDMode="Static"></asp:TextBox>
                    </div>

                            <asp:RangeValidator ID="RangeValidator2" runat="server"
                                ControlToValidate="txtQuestionsPerTest" ErrorMessage="RangeValidator"
                                MaximumValue="10000" MinimumValue="1" Type="Integer" CssClass="Formerror">*</asp:RangeValidator>
            ...
            <tr>
                <td>Admin View Option</td>
                <td> <div style="float: left; padding-top: 8px;">
                    <asp:CheckBox ID="chkAdminview" runat="server" Text="Allow System Admin View This Assessment" />
                </div></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
    ...
    <div style="padding: 10px; border: 1px solid #f3ebeb; min-height: 250px;" id="divTopics" runat="server" visible="False" clientidmode="Static">
        ...
        <asp:ObjectDataSource ID="DifficultyDataSource" runat="server" SelectMethod="GetLevels" TypeName="Fot.Admin.Services.QuestionDifficultyLevelService" DeleteMethod="Delete" EnablePaging="True" MaximumRowsParameterName="maxRows" StartRowIndexParameterName="startRow" SelectCountMethod="Count">
            <DeleteParameters>

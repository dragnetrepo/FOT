<%@ Page Title="" Language="C#" MasterPageFile="PartnerMaster.Master" AutoEventWireup="true" CodeBehind="AddOrEditBundle.aspx.cs" Inherits="Fot.Admin.Client.AddOrEditBundle" %>
    ...
    <div style="padding:10px;">
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBundleName" runat="server" Width="690px" CssClass="validate[required]" data-errormessage-value-missing="Assessment bundle name is required!"></asp:TextBox>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
        ...
        <asp:ObjectDataSource ID="BundleAssessmentsDataSource" runat="server" SelectMethod="GetAssessmentsInBundle" TypeName="Fot.Admin.Services.PartnerAssessmentService" DeleteMethod="DeleteAssessmentFromBundle">
            <DeleteParameters>
        ...
        <asp:ObjectDataSource ID="NotInBundleDataSource" runat="server" SelectMethod="GetAssignedAndPartnerAssessmentsNotInBundle" TypeName="Fot.Admin.Services.PartnerAssessmentService">
            <SelectParameters>
                <asp:ControlParameter ControlID="hidId" Name="BundleId" PropertyName="Value" Type="Int32" />
            </SelectParameters>
        </asp:ObjectDataSource>

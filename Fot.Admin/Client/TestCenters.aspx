<%@ Page Title="" Language="C#" MasterPageFile="PartnerMaster.Master" AutoEventWireup="true" CodeBehind="TestCenters.aspx.cs" Inherits="Fot.Admin.Client.TestCenters" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="CenterDataSource" runat="server" DeleteMethod="Delete" MaximumRowsParameterName="maxRows" SelectCountMethod="Count" SelectMethod="GetCenters" StartRowIndexParameterName="startRow" TypeName="Fot.Admin.Services.PartnerCenterService" EnablePaging="True">
            <DeleteParameters>

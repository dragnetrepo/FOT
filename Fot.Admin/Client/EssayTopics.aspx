<%@ Page Title="" Language="C#" MasterPageFile="PartnerMaster.Master" AutoEventWireup="true" CodeBehind="EssayTopics.aspx.cs" Inherits="Fot.Admin.Client.EssayTopics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="EssayTopicsDataSource" runat="server" DeleteMethod="Delete" SelectMethod="GetTopics" TypeName="Fot.Admin.Services.PartnerEssayTopicService" SelectCountMethod="Count" MaximumRowsParameterName="maxRows" StartRowIndexParameterName="startRow" EnablePaging="True">
            <DeleteParameters>

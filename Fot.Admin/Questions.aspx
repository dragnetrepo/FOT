<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Questions.aspx.cs" Inherits="Fot.Admin.Questions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <telerik:RadListView ID="RadListView1" runat="server" AllowPaging="True" DataSourceID="QuestionDataSource" DataKeyNames="QuestionId" OnItemCommand="RadListView1_ItemCommand" OnItemDeleting="RadListView1_ItemDeleting" Skin="Windows7" ItemType="Fot.Admin.Models.QuestionViewModel">
            ...
            <ItemTemplate>
                <div class="divQContainer">
                    ...
                    <div class="divOptions">
                         <div style="float: left; margin-right: 50px; margin-top: 5px;"><strong>Total Served: </strong><%# Item.TotalServed.ToString("#,##0") %></div>
                        <div style="float: left; margin-right: 50px; margin-top: 5px;"><strong>Total Right: </strong><%# Item.TotalRight.ToString("#,##0") %></div>
                         <div style="float: left; margin-right: 50px; margin-top: 5px;"><strong>Total Wrong: </strong><%# Item.TotalWrong.ToString("#,##0") %></div>
                          <div style="float: left; margin-right: 10px; margin-top: 5px;"><strong>Availability: </strong>
                            <img src='images/<%# Item.Retired  ?  "exclamation.png" : "accept.png"  %>' style="height: 14px; vertical-align: middle" /></div>
                        </div>
                </div>
            </ItemTemplate>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="QuestionDataSource" runat="server" SelectMethod="GetQuestions" TypeName="Fot.Admin.Services.AssessmentQuestionService" MaximumRowsParameterName="maxRows" SelectCountMethod="QuestionCountByAssessment" StartRowIndexParameterName="startRow" EnablePaging="True">
            <SelectParameters>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CampaignDetails.aspx.cs" Inherits="Fot.Admin.CampaignDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <telerik:RadPageView ID="RadPageView1" runat="server">
                <div style="padding: 10px; border: 1px solid #ccc; margin-top: 10px; height: 430px; width: 100%; float: left;">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td style="width: 150px;">Partner</td>
                            <td>
                                <asp:DropDownList ID="listPartners" runat="server" DataSourceID="PartnerDataSource" DataTextField="PartnerName" DataValueField="PartnerId">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="listPartners" CssClass="Formerror" ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
    ...
    <div style="padding: 10px; text-align: center; width: 100%; float: left; clear: both">
        ...
        <div class='boxDiv' id="boxResult" runat="server">
         ...
         <div class='boxDiv' id="boxTests" runat="server" Visible="False">
            <div class='codeStyle'>Online Tests</div>
        </div>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="BundleDataSource" runat="server" MaximumRowsParameterName="maxRows" SelectMethod="GetBundles" TypeName="Fot.Admin.Services.AssessmentBundleService">
            <SelectParameters>

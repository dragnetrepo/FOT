<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddOrEditQuestion.aspx.cs" Inherits="Fot.Admin.AddOrEditQuestion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding: 10px;">
        <table style="width: 100%;">
            ...
            <tr runat="server" ID="rowRetire">
                <td style="vertical-align: top; width: 150px">Availability</td>
                <td>
                        <asp:CheckBox ID="chkRetire" runat="server" Text="Retire this question" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
    ...
    <div>
        <asp:ObjectDataSource ID="OptionsDataSource" runat="server" SelectMethod="GetAnswers" TypeName="Fot.Admin.Services.AssessmentAnswerService">
            <SelectParameters>

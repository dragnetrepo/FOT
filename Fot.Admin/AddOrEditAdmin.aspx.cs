    ...
    public partial class AddOrEditAdmin : System.Web.UI.Page
    {
        ...
        private void LoadForUpdate(int id)
        {
            ...
            if (item != null)
            {
                ...
                chkListPermissions.Items[3].Selected = item.HasFinancialsAccess;
                chkListPermissions.Items[4].Selected = item.HasUsersAccess;
                chkListPermissions.Items[5].Selected = item.HasPartnerUsersAccess;
                chkListPermissions.Items[6].Selected = item.HasCenterUsersAccess;
        ...
        private void AddAdmin()
        {
            var item = new AdminUser
            {
                ...
                HasFinancialsAccess = chkListPermissions.Items[3].Selected,
                HasUsersAccess = chkListPermissions.Items[4].Selected,
                HasPartnerUsersAccess = chkListPermissions.Items[5].Selected,
                HasCenterUsersAccess = chkListPermissions.Items[6].Selected
            };
        ...
        private void UpdateAdmin()
        {
            ...
            if (item != null)
            {
                ...
                item.HasFinancialsAccess = chkListPermissions.Items[3].Selected;
                item.HasUsersAccess = chkListPermissions.Items[4].Selected;
                item.HasPartnerUsersAccess = chkListPermissions.Items[5].Selected;
                item.HasCenterUsersAccess = chkListPermissions.Items[6].Selected;
        ...
        private void AddAssessment()
        {
            ...
            var service = new AuthorAssignedAssessmentService();

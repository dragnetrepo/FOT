<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Administrators.aspx.cs" Inherits="Fot.Admin.Administrators" %>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="AdminUsersDataSource" runat="server" DeleteMethod="DeleteAdminUser" SelectMethod="GetAdminUsers" TypeName="Fot.Admin.Services.AdminUserService" MaximumRowsParameterName="maxRows" SelectCountMethod="Count" StartRowIndexParameterName="startRow" EnablePaging="True">
            <DeleteParameters>
